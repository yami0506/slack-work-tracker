...
- 作業開始・終了の成功メッセージは、共有通知が有効ならパネルのスレッドに表示されます。無効なら本人だけに表示されます。
...
共有通知が無効な場合や、共有通知の投稿に失敗した場合は、押した本人にephemeralメッセージで表示されます。
...
この設定が有効な場合、作業開始・終了の成功メッセージは本人向けephemeralではなく、パネルのスレッドに投稿されます。
エラーや「すでに作業中です」のような個人向けの案内は、引き続き本人だけに表示されます。
